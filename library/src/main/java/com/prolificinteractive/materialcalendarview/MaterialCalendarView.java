...
public class MaterialCalendarView extends ViewGroup {
    ...
    private final TextView buttonPast;
    private final TextView buttonFuture;
    ...
    private final ViewPager.OnPageChangeListener pageChangeListener =
            new ViewPager.OnPageChangeListener() {
                ...
                public void onPageSelected(int position) {
                    ...
                    previousMonth = adapter.getItem(position-1);
                    nextMonth = adapter.getItem(position+1);
                    updateUi();
                ...
                public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                    if (positionOffset == 0) {
                        // set our
                        Log.d("CALENDAR", "Updating: " + positionOffset);
                        return;
                    }
                    ...
                    titleChanger.offset(positionOffset);
                    Log.d("CALENDAR", "Scrolled offset: " + positionOffset);
                    Log.d("CALENDAR", "Scrolled position: " + position);
                    Log.d("CALENDAR", "Scrolled pixels: " + positionOffsetPixels);
                }
            };
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        topBarWrapper = content.findViewById(R.id.root);
        ...
        yearView = content.findViewById(R.id.yearHeader);
        ...
        titleChanger = new TitleChanger(title,buttonPast, buttonFuture, topbar, yearView);
    ...
    private void updateUi() {
        Log.d("LIB_UI", "Updating UI");
        titleChanger.change(currentMonth, previousMonth, nextMonth);
...
//    buttonFuture.setImageResource(icon);
    ...
    public void setHeaderTextAppearance(int resourceId) {
        ...
        buttonPast.setTextAppearance(getContext(), resourceId);
        buttonFuture.setTextAppearance(getContext(), resourceId);
        buttonPast.setTypeface(null, Typeface.NORMAL);
        buttonFuture.setTypeface(null, Typeface.NORMAL);
    }
